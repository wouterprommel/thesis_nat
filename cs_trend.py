...
if True:
    ...
    axis[0].errorbar(E, exp, yerr=exp_err, linestyle='-', marker='.', label='PDF3.1 LO with xmin = 1e-2')
    axis[0].errorbar(E, x31, yerr=x31_err, linestyle='-', marker='.', label='PDF3.1 LO with xmin = 1e-7')
    ...
    axis[1].errorbar(E, exp/cs, yerr=exp_err/cs, linestyle='-', marker='.', label='PDF3.1 LO with xmin = 1e-2')
    axis[1].errorbar(E, x31/cs, yerr=x31_err/cs, linestyle='-', marker='.', label='PDF3.1 LO with xmin = 1e-7')
